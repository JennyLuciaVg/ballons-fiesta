...
$navbar-height: 7.5rem !default
$navbar-height-touch: 4.5rem !default

$navbar-item-color: $white !default
$navbar-item-color-touch: $primary !default
$navbar-item-hover-color: $danger !default
$navbar-item-hover-background-color: $background !default
$navbar-item-active-color: $danger !default
$navbar-item-active-background-color: transparent !default
$navbar-item-img-max-height: 7.5rem !default
$navbar-item-img-max-height-touch: 3.5rem !default
...
+touch
  ...
  .navbar-brand
    ...
    .navbar-item
      ...
      display: flex
      img
        max-height: $navbar-item-img-max-height-touch
  .navbar-burger
    +hamburger($navbar-height-touch)
  .navbar-menu
